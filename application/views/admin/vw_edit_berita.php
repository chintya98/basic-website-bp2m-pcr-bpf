<div class="right_col" role="main">
	<div class="row justify-content-center">
		<div class="col-md-9 col-sm-9">
			<div class="x_panel">
				<div class="x_title">
					<h2>Edit Berita <small>BP2M PCR</small></h2>
				...
				<div class="x_content">
                    ...
                    <input type="hidden" name="id" value="<?= $berita['id']; ?>">
						...
						<select name="kategori" id="kategori" class="form-control" value="<?= $berita['nama'];?>">
                        <?php foreach ($kategori as $ka) : ?>
									<option value="<?= $ka['id']; ?>" <?php if($berita['kategori'] == $ka['id']){
                                        echo "selected"; 
                                    } ?>> <?= $ka['kategori']; ?></option>
								<?php endforeach ; ?>
						</select>
						...
						<textarea name="isi" id="ckeditor" value="<?= $berita['isi']; ?>"> <?= $berita['isi']; ?> </textarea>
